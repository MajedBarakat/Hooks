  ...
  return (
    <>
      ...
      <Form.Group className="mb-3" >
        ...
        <Form.Control type="text" placeholder="discription..." onChange={(e)=>setdiscription(e.target.value)}/>
      </Form.Group>
      ...
      <Form.Group className="mb-3" >
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={()=>{handleMovies({name,url,discription,year,rating});handleClose()}}>save</Button>
        </Modal.Footer>
      </Modal>
    </>
  );
